...
abstract class Model implements \JsonSerializable, \ArrayAccess
{
    ...
    public function __construct($data = [])
    {
        ...
        if (is_null($this->autoDatetimeFormat)) {
            // 开启时间戳自动转换
            $this->autoDatetimeFormat = $this->db(false)->getConfig('auto_datetime_format');
        }
